...
uc_hopoff_mdp_outhor = HopOffMDP(params)
...
hopoff_grid_outhor = hopoff_grid_inhor = RectangleGrid([0, 1], [params.time_params.HORIZON_LIM+1])
...
policy_fn_inhor = string(policy_name,"-inhor.jld2")
policy_fn_outhor = string(policy_name,"-outhor.jld2")

save_localapproxvi_policy_to_jld2(policy_fn_inhor, approx_hopoff_inhorizon_policy, uc_hopoff_mdp, 5)
save_localapproxvi_policy_to_jld2(policy_fn_outhor, approx_hopoff_inhorizon_policy, uc_hopoff_mdp, 5)
